 ...
 * @brief File with method definitions for the (field subgroup) group 3 on a
 * cryptographic pairing
 *
 * This file defines the type and methods for manipulating elements form the
 * third group (multiplicative notation) of a cryptographic pairing, including
 * serialization, multiplication...
 * 
...
/**
 * Encapsulated declaration of type G3, which represents elements from
 * G3 of the pairing
 */
typedef struct G3Impl G3;

/**
 * @brief Generates a copy of the unity. Can be safely modified . Has to be
 * freed after usage
 * 
 * @return 
 */
...
/**
 * @brief Represent G3 element as byte array. Array is assumed to be big enough
 * for copy
 * 
