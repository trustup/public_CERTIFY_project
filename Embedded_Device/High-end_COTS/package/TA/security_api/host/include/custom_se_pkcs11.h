...
/**
  ...
  * @note   baseKeyID and derivedKeyID admitted values: "PSK", "MSK", "PSK_1", "PSK_2", "PSK_3", "PSK_4", "PSK_5", "PSK_6", "PSK_7".
  * @note   algo admitted values: HMAC, AES128
  * @note   values for baseKeyID: "PSK_[1-7]" are only valid for "HMAC"
...
/**
  * @brief  Encrypt data
  * @note   encriptionKeyId admitted values: "EDK".
  * @note   algo admitted values: AES-256-CBC
...
/**
  * @brief  Encrypt data
  * @note   decriptionKeyId admitted values: "EDK".
  * @note   algo admitted values: AES-256-CBC
...
/**
 * @brief Reconfigure device
 * @param opcode signle byte operation code indicating the reconfiguration action
 * @param operationData buffer with reconfiguration information, its size will depend on the operation code
 * @param operationDataLen Byte length of data
 * @retval return 0 means OK
 */
...
#include <stdlib.h>
// Temporary for testing pourpuses
