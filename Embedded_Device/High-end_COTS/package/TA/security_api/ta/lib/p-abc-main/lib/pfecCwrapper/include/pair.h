 ...
 *
 * This file defines the methods for pairing, including a simple pair
 * and optimized multi-pairings
 * 
...
/**
 * @brief Pairing operation result=e(a,b). Result is a generated G3
 * element that must be freed after use
 * 
...
/**
 * @brief Multi-pairing operation result=PI(e(a_i,b_i)). Result is a
 * generated G3 element that must be freed after use
 *  
 * 
...
/**
 * @brief Double pairing operation result=e(a1,b1)*e(a2,b2). Result is
 * a generated G3 element that must be freed after use
 *  
 * 
