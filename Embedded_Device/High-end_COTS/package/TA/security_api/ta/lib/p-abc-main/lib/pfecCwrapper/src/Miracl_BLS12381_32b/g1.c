...
#define MULNBREAKPOINT 12 // Experimentally computed value, until this
			  // point naive n-multiplication is faster
...
/* https://datatracker.ietf.org/doc/draft-irtf-cfrg-hash-to-curve/ */
static void hash_to_field_BLS12381(
	int hash,int hlen,FP_BLS12381 *u,octet *DST,octet *M, int ctr)
{
    int i,j,L,k,m;
    BIG_384_29 q,w,r;
    DBIG_384_29 dx;
...
static int htp_BLS12381(const char *mess, int n, ECP_BLS12381 *P)
{
    ...
    OCT_jstring(
	    &DST,(char *)"QUUX-V01-CS02-with-BLS12381G1_XMD:SHA-256_SSWU_RO_");
...
int g1ByteSize(){
    return 2*MODBYTES_384_29+1; //0x04|x|y TODO, Check compressed
				//serializations for possible usage
}
