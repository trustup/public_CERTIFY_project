...
struct edge_data wait_for_message() {
  ...
  if (actual_test_case == CMD_INSTALL_PSK) {
    printf("[HOST] Initializing PSK installation\n");  
    ...
    printf("[HOST] Sending MudURL to Enclave (Secure World)\n");
    // printf("[DEBUG] buffer: ");
    ...
    printf("[HOST] Initializing MUD URL installation\n");
    ...
    printf("[HOST] Host send MudURL to Enclave (Secure World): %s\n", (char*)(buffer + sizeof(int)));
    message.offset = (uintptr_t)buffer;
    message.size = total_size;
  } else if(actual_test_case == CMD_INSTALL_CERT){
    printf("[HOST] Initializing Certificate installation\n");
    ...
    printf("[HOST] Host send Certificate to Enclave (Secure World): %s\n", (char*)(buffer + sizeof(int)));
    message.offset = (uintptr_t)buffer;
    message.size = total_size;
  } else if (actual_test_case == CMD_GET_CERT) {
    printf("[HOST] Initializing Certificate retrieval\n");
    ...
    printf("[HOST] Initializing key derivation\n");
    ...
    printf("[HOST] Obtaining ak_psk from %s\n", key_path);
    ...
    // printf("\n");
    printf("[HOST] Sending data to sign \n");
    message.offset = (uintptr_t)buffer;
    message.size = total_size;
  } else if (actual_test_case == CMD_ENCRYPT){
    printf("[HOST] Initializing encrypt\n");
    ...
    printf("[HOST] Initializing decrypt\n");
    ...
    printf("[HOST] Initializing random generation\n");
    ...
    printf("[HOST] Initializing reconfiguration\n");
    ...
    printf("[HOST] Sending reconfiguration\n");
    message.offset = (uintptr_t)buffer;
    message.size = total_size;
  }
