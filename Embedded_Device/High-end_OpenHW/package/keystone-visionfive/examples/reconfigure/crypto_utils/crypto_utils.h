...
// --- SHA256 API (TinyCrypt, integrado) ---
...
} tc_sha256_state_struct, *TCSha256State_t;
...
int sha256_digest_do_final(TCSha256State_t s, const uint8_t *data, size_t data_len, uint8_t *digest);
