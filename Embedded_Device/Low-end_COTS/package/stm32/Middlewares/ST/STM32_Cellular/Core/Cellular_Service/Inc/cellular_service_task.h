...
#define CST_PPP_CONFIG_ON_GOING_STATE                   (CST_autom_state_t)17U

/* PDN Activated - PPP close in Progress */
#define CST_PPP_CLOSE_ON_GOING_STATE                    (CST_autom_state_t)18U

/* Numder of states */
#define CST_MAX_STATE                                   19U
...
#define CST_PPP_OPENED_EVENT                       (cst_autom_event_t)25U  /* ppp opened */
#define CST_PPP_CLOSED_EVENT                       (cst_autom_event_t)26U  /* ppp closed */
#define CST_MODEM_POWER_DOWN_EVENT                 (cst_autom_event_t)27U  /* modem power down event */
#if (USE_LOW_POWER == 0)
#define CST_MAX_EVENT                              28U
#else /* (USE_LOW_POWER == 1) */
#define CST_POWER_SLEEP_TIMEOUT_EVENT              (cst_autom_event_t)28U  /* low power entry timeout */
#define CST_POWER_SLEEP_REQUEST_EVENT              (cst_autom_event_t)29U  /* low power request */
#define CST_POWER_SLEEP_COMPLETE_EVENT             (cst_autom_event_t)30U  /* low power completed */
#define CST_POWER_WAKEUP_EVENT                     (cst_autom_event_t)31U  /* exit from low power Host wakeup*/
#define CST_POWER_MODEM_WAKEUP_EVENT               (cst_autom_event_t)32U  /* exit from low power Modem wakeup*/
#define CST_POWER_SLEEP_ABORT_EVENT                (cst_autom_event_t)33U  /* low power request abort */
#define CST_MAX_EVENT                              34U
