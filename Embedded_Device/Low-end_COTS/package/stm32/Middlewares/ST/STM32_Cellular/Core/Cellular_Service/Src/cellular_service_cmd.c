...
static cmd_status_t CST_cmd(uint8_t *cmd_line_p)
{
  ...
  static const uint8_t *CST_networkRegModeToString_p[CST_NETWORK_REG_MODE_MAX] =
  {
    ((uint8_t *)"Auto"),
    ((uint8_t *)"Manual"),
    ((uint8_t *)"Deregister"),
  ...
  static const uint8_t *CST_operatorNameFormatToString_p[CST_OPERATOR_NAME_FORMAT_MAX] =
  {
    ((uint8_t *)"Long"),
    ((uint8_t *)"Short"),
    ((uint8_t *)"Numeric"),
  ...
  static const uint8_t *CST_accessTechnoToString_p[CST_ACCESS_TECHNO_MAX] =
  {
    ((uint8_t *)"GSM"),
    ((uint8_t *)"GSM compact"),
    ((uint8_t *)"UTRAN"),
        ...
        == 0)
    {
                      ...
                      crs_strlen(argv_p[0])) == 0)
      {
        ...
        PRINT_FORCE("Network register mode: %d (%s)", cst_cmd_cellular_info.access_techno,
                    CST_accessTechnoToString_p[cst_cmd_cellular_info.access_techno]);
               ...
               == 0)
      {
        ...
        PRINT_FORCE("Access techno present: %s",
                    (cst_cmd_cellular_params.operator_selector.access_techno_present ? "Present" : "Not present"));
      ...
      else if (memcmp((CRC_CHAR_t *)argv_p[0], "techno", crs_strlen(argv_p[0])) == 0)
      {
        ...
        if (argc == 3U)
        {
          ...
          /* tmpConversion is unsigned, no need to test it's value is greater or equal than zero */
