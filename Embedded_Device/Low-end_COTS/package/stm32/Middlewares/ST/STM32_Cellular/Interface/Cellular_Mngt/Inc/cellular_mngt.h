...
/**
 ...
 1) boot the modem with network registration in order to make data transfer
    cellular_init() --> cellular_start()

 2) boot the modem with network registration with network library use, in order to make data transfer
    cellular_net_init() --> cellular_net_start()
     Note: the use of Network Library component is useful in 2 main cases:
