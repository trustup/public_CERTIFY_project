...
/** @defgroup COM_UTILS Com Utilities
  * @{
  */


/* Exported constants --------------------------------------------------------*/
/** @defgroup COM_UTILS_Constants Constants
  * @{
  */
/**
  * @}
...
/* Exported types ------------------------------------------------------------*/
/** @defgroup COM_UTILS_Types Types
  * @{
  */
...
/* External variables --------------------------------------------------------*/
/** @defgroup COM_UTILS_Variables Variables
  * @{
  */
...
/* Exported macros -----------------------------------------------------------*/
/** @defgroup COM_UTILS_Macros Macros
  * @{
  */
